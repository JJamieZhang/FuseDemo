...
function MainNavbar({ classes, navigation, layoutStyle, user }) {
	function UserHeader() {
		return (
			...
			>
				<Typography className="username text-16 whitespace-no-wrap" color="inherit">Jamie Zhang</Typography>
				<Typography className="email text-13 mt-8 opacity-50 whitespace-no-wrap" color="inherit">Developer</Typography>
				<Avatar
